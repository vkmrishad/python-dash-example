            ...
            dbc.Row([
                dbc.Col(dbc.Card(
                    dbc.CardBody([
                        ...
                        html.P(id='total_orders', className="card-text"),
                        html.P(id='date_range_orders', className="card-date"),
                    ]),
                    color="primary", inverse=True, className="mb-3 text-white hover-card",
                ), width=3),
                dbc.Col(dbc.Card(
                    dbc.CardBody([
                        html.H4("Total Sales", className="card-title"),
                        html.P(id='total_sales', className="card-text"),
                        html.P(id='date_range_sales', className="card-date"),
                    ]),
                    color="info", inverse=True, className="mb-3 text-white hover-card",
                ), width=3),
                dbc.Col(dbc.Card(
                    dbc.CardBody([
                        html.H4("Total Profit", className="card-title"),
                        html.P(id='total_profit', className="card-text"),
                        html.P(id='date_range_profit', className="card-date"),
                    ]),
                    color="success", inverse=True, className="mb-3 text-white hover-card",
                ), width=3),
                dbc.Col(dbc.Card(
                    dbc.CardBody([
                        html.H4("Profit Ratio", className="card-title"),
                        html.P(id='profit_ratio', className="card-text"),
                        html.P(id='date_range_ratio', className="card-date"),
                    ]),
                    color="dark", inverse=True, className="mb-3 text-white hover-card",
                ), width=3),
            ]),
            dbc.Row([
                dbc.Col(dbc.CardLink(
                    dbc.Card(
                        dbc.CardBody([
                            html.H4("Table"),
                            html.P("Go to Table Page", className="card-link-text")
                        ]),
                        color="warning", inverse=True, className="mb-3 text-white hover-card",
                    ), href="/table"
                ), width=6),
                dbc.Col(dbc.CardLink(
                    dbc.Card(
                        dbc.CardBody([
                            html.H4("Graph"),
                            html.P("Go to Graph Page", className="card-link-text")
                        ]),
                        color="danger", inverse=True, className="mb-3 text-white hover-card",
                    ), href="/graph"
                ), width=6),
            ], id="go-to-pages"),
        ]
